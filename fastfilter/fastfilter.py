...
if __name__ == "__main__":
    ...
    if args.mode == "makedb":
        if args.method == "kraken":
            fastfilter.make_kraken_db_from_fasta(args.fasta, args.db_location, args.threads, args.kmer_size, args.file_extensions)
        if args.method == "kaiju":
            fastfilter.make_kaiju_db_from_fasta(args.fasta_file, args.db_location, args.threads)
